  ...
  return (
    <div id='rehberlik'>
        <div className="rehberliktop">
            <img src={Photorehberlik} alt="FAM-Group-Construction-Rehberlik"/>
        </div>
            ...
            <div className="container">
                ...
                <div className="row g-2">
                    <div className="col-xl-4">
                        <img src="https://img.freepik.com/premium-vector/default-avatar-profile-icon-social-media-user-image-gray-avatar-icon-blank-profile-silhouette-vector-illustration_561158-3383.jpg" alt="FAM-Group-Construction-Rehberlik" />
                        <h3>Baş Direktor</h3>
                        <h4>İlkin Ağayev</h4>
                    </div>
                    <div className="col-xl-4">
