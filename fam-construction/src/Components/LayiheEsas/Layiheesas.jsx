    ...
    <div id='layiheesas'>
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690657671_7.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690656674_1.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690656001_11.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690654975_3.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690654289_s1-2.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2023-07/1690635551_q1.jpg" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2021-07/1627029549_bez-imeni-1.png" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src="https://famgroupconstruction.az/uploads/posts/2021-07/1627027789_1111111111.png" class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photoleaf} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photobs} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photoengixaran} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photocuvarli} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photogreenhouse} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
            <h5 class="card-title"> İsmayıllı Gren House </h5>
            <br />
            <Link to="/ismayilli/gren-house" class="btn btn-primary">ƏTRAFLI MƏLUMAT</Link>   
          </div>
        </div>
          </div>
          <div className="col-xl-4">
          <div class="card">
          <img src={Photomuhafize} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
          ...
          <div className="col-xl-4">
          <div class="card">
          <img src={Photoqusarhub} class="card-img-top" alt="FAM-Group-Construction-Layiheler"/>
          <div class="card-body">
